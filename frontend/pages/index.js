            ...
            <div className="col-lg-6 col-md-8 col-sm-11">
              <div className="hero-text">
                ...
                <p className="wow fadeInLeft" data-wow-delay="0.3s">
                  Join us in making a difference. Your support helps us to provide essential resources and make a positive impact in our community.
                </p>
            ...
            <div className="row align-items-end justify-content-xl-start">
              <div className="col-xl-5 col-lg-7 col-md-8 order-xl-2">
                <div className="about-text">
                  ...
                  <a href="https://hackindia.xyz/" target="_blank">
            ...
            <div className="row align-items-end justify-content-xl-start">
              <div className="col-xl-5 col-lg-7 col-md-8 order-xl-2">
                <div className="about-text">
                  ...
                  <p>
                    At Hackindia, we are dedicated to transforming lives by supporting impactful charity projects. Join us in our mission to create positive change and uplift communities.
                  </p>
                  <ul className="check-list mt-30">
                    <li>
                      <h5 className="title">
                        Trusted by Compassionate Donors
                      </h5>
                      <p>
                        Our platform is trusted by many who seek to make a difference through charitable giving.
                      </p>
                    </li>
                    <li>
                      <h5 className="title">Fundraising with Impact</h5>
                      <p>
                        Launch fundraising campaigns and turn your charitable ideas into reality.
                      </p>
                    </li>
                    <li>
                      <h5 className="title">Millions Raised for Good Causes</h5>
                      <p>
                        Hackindia has successfully raised significant funds to support various charitable initiatives.
                      </p>
                    </li>
                  </ul>
                  <a href="https://hackindia.xyz/" target="_blank" rel="noopener noreferrer">
                    <div className="main-btn btn-dark mt-40">
                      Learn More <i className="far fa-arrow-right" />
                    </div>
                  </a>
                </div>
              ...
              <div className="col-xl-5 order-xl-1 wow fadeInUp">
                <div className="about-curved-img">
                  <img src="assets/img/about/wizard.png" alt="Charity" />
                </div>
              </div>
            </div>
          </div>
